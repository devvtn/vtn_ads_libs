...
public abstract class Admob {
    ...
    public abstract void loadAndShowInter(AppCompatActivity activity, String idInter, int timeDelay, int timeOut, AdCallback callback);
    ...
    public abstract void onCheckShowSplashWhenFail(final AppCompatActivity activity, final AdCallback callback, int timeDelay);
